                            ...
                            <div class="card-body pt-0" style="min-height:120px;">
                              <div class="row">
                                ...
                                <div class="col-3 text-center">
                                  <img src="${userImg}" alt="User Image" class="img-circle img-fluid">
                                </div>
                              </div>
                            </div>
                            <div class="card-footer">
                              <div class="text-right">
                                <a href="#" class="btn btn-sm bg-success btn_activate" data-user_id=" ${user.user_id}">
                                  <i class="fas fa-thumbs-up"> Unblock Alumni</i>
                                </a>
                  ...
                  Swal.fire({
                         ...
                         if (result.value == true) {
                             $.ajax({
                                  ...
                                  if (data == 1) {
                                    Swall('Alumni Unblocked!', 'The Selected Alumni Unblocked!', 'success');
                                    setTimeout(function() {
                                              location.reload();
