        ...
        success: function (response) {
            try {
                        ...
                        <div class="col-md-4 col-lg-4 col-xs-12 col-sm-12">
                          <div class="card bg-light">
                            ...
                            <div class="card-body pt-0" style="min-height:120px;">
                              <div class="row">
                                <div class="col-md-9 ">
                                  <h2 class="lead"><b>${user.fname} ${user.mname} ${user.lname}</b></h2>
                                ...
                                <div class="col-3 text-center">
                                   <img src="${userImg}" alt="User Image" style="width:120px;height:120px;object-fit-cover;" class="img-circle img-fluid">
                                </div>
                              </div>
                            </div>
                            <div class="card-footer bg-wihte">
                              <div class="text-right">
                                <a href="#" class="btn btn-sm bg-teal btn-approve" data-user_id=" ${user.user_id}">
                                  <i class="fas fa-thumbs-up"> Approve</i>
                                </a>
                                <a href="#" class="btn btn-sm bg-danger btn-reject" data-user_id=" ${user.user_id}">
                                  <i class="fas fa-thumbs-down"> Reject</i>
                                </a>
                                <a href="#" class="user_profile_btn btn btn-sm btn-primary" data-user_id=" ${user.user_id}">
             ...
             $('.btn-approve').click(function(){
              ...
              Swal.fire({
                      title: 'Approve Alumni Application',
                      text: 'Are you sure?',
                      icon: 'info',
                     ...
                     if (result.value == true) {
                         $.ajax({
                              url:'ajax/approve_alumni.php',
                              type:'GET',
                              data:{userid:User_id},
                              dateType:'html'
                            }).done(function(data){
                              if (data == 1) {
                                Swall('Application Approved!', 'Alumni Application Approved!', 'success');
                                setTimeout(function() {
                                          location.reload();
                                      }, 3000); // 3000 milliseconds = 3 seconds

                              }else{
                                Swall('Application Rejected!', 'Alumni Application Rejected!', 'warning');
                              }
                          });
                       }     
