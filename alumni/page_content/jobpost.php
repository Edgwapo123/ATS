<div class="container-fluid banner-section p-0">
  <div class="banner-image">
    <img src="images/jobpost.png" alt="Alumni Banner" class="img-fluid w-100">
  </div>
</div>
<div class="container text-center my-5">
  <h1>Welcome to Alumni Job Posting Page</h1>
  <p>Stay updated with the latest events, meet with your old buddies.</p>
</div>
<div id="post-container" class="row align-items-stretch">
<?php 
    $sql = "SELECT * FROM `post` WHERE `post_category`='JobPost' AND `post_status`=1 ORDER BY `post_date` DESC LIMIT 6";
    $query = $con->query($sql);
