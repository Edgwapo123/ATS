<div class="container-fluid banner-section p-0">
  <div class="banner-image">
    <img src="images/trainings.png" alt="Alumni Banner" class="img-fluid w-100">
  </div>
</div>
<div class="container text-center my-5">
  <h1>Welcome to Alumni Training Opportunities</h1>
  <p>Develop and Hone Skills With Our Trainings and Seminars</p>
</div>
<div id="post-container" class="row align-items-stretch">
<?php 
    $sql = "SELECT * FROM `post` WHERE `post_category`='Trainings' AND `post_status`=1 ORDER BY `post_date` DESC LIMIT 6";
    $query = $con->query($sql);
