<div class="container-fluid banner-section p-0">
  <div class="banner-image">
    <img src="images/donation2.png" alt="Alumni Banner" class="img-fluid w-100">
  </div>
</div>
<div class="container text-center my-5">
  <h1>Welcome to Alumni Donation Page</h1>
  <p>Thank you for the continued support, Stay connected Alumni.</p>
</div>
<div id="post-container" class="row align-items-stretch">
<?php 
    $sql = "SELECT * FROM `post` WHERE `post_category`='Donations' AND `post_status`=1 ORDER BY `post_date` DESC LIMIT 10";
    $query = $con->query($sql);
